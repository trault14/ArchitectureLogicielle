...
public class DiagrammeElementScripterVisitor implements DiagrammeElementVisitor {
	...
	public int nbParents(DiagrammeElement element){
		int nb = 0;
		while(element.getParent()!=null){ //TODO si on change l'element null, remplacer ici aussi
			nb++;
	...
	public void visit(Diagramme diagramme) { 
		/* TODO dans le accept d'un diagramme, le diagramme se visite en dernier. 
		 * Du coup il est tout en bas, il faudrait remedier à ça sans toucher à la classe Diagramme (i.e. tout faire ici).
		 */
		String str = "";
	...
	public void visit(Fleche fleche) {
		...
		System.out.println(str+".fleche("+fleche.nomBase+","+fleche.nomPointe+")");
	...
	public void visit(Methode methode) {
		...
		System.out.println(str+".methode("+methode.visibility+","+methode.nom+","+methode.returnType+")");
	...
	public void visit(Variable var) {
		...
		System.out.println(str+".variable("+var.visibility+","+var.nom+","+var.typeVariable+")");
	}
